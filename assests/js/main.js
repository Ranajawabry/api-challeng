...
const display= (users)=>{
    ...
    users.forEach(async(user)=>{
        ...
        <div class="single-item col-lg-4 col-md-6  bg-secondary rounded-3 my-1">
                <div class="row p-2" >
                    <div class="col-3">
                        <img src=${user.avatar_url} class="w-100" alt="">
                    </div>
                    <div class="col-9 ps-4">
                        ...
                        <div class="follow d-flex justify-content-between bg-dark text-white p-3 rounded-2">
                            <div class="follower">
                        ...
                        <div class="d-flex flex-wrap spcial-info my-3">
                            <div class="col-6 my-2">
                                <i class="fa-solid fa-location-dot pe-5 fs-5"></i>
                                <span> ${user.location} </span>
                            </div>
                            <div class="col-6 my-2">
                                <i class="fa-brands fa-twitter pe-5 fs-5"></i>
                                <span>${user.twitter_username}</span>
                            </div>
                            <div class="col-6 my-2">
                                <a href=${user.blog}><i class="fa-solid fa-house-user pe-5 fs-5"></i></a>
                                <span> Blogs </span>
                            </div>
                            <div class="col-6 my-2">
                                <a href=${user.html_url}><i class="fa-solid fa-house-user pe-5 fs-5"></i></a>
                                <span> github</span>
                            </div>
